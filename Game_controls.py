...
class HealthBarClass:
    ...
    def player_one_punched(self, blocking):
        if blocking:
            self.player_one_health -= 1 / 2
            if self.player_one_health > 127.5:
                self.player_one_health2 += 2 / 2
            else:
                self.player_one_health1 -= 2 / 2
        else:
            self.player_one_health -= 1
            if self.player_one_health > 127.5:
                self.player_one_health2 += 2
            else:
                self.player_one_health1 -= 2
    ...
    def player_one_kicked(self, blocking):
        if blocking:
            self.player_one_health -= 2 / 2
            if self.player_one_health > 127.5:
                self.player_one_health2 += 4 / 2
            else:
                self.player_one_health1 -= 4 / 2
        else:
            self.player_one_health -= 2
            if self.player_one_health > 127.5:
                self.player_one_health2 += 4
            else:
                self.player_one_health1 -= 4
