...
class HealthBarClass:
    ...
    def draw_health_bars(self, display, player_one_health, player_two_health, window_width, background_color, outline_color, black_color,
        ...
        pygame.draw.rect(display, player_one_health_color, pygame.Rect(screen_spacing_1 + 3 * screen_spacing_2, screen_spacing_1 + 3 * screen_spacing_2, (health_bar_length - 6 * screen_spacing_2) * (player_one_health / 255), 3 * screen_spacing_2))
